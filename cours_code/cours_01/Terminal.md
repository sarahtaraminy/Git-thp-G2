...
<<<<<<< HEAD
Le terminal est un outil intimidant aux premiers abords, mais au final se r�v�le pas compliqu�. J'ai r�alis� [une vid�o](https://youtu.be/myz_6xrDwR4) qui explique le terminal.
...
<<<<<<< HEAD
Michael Hartl a fait une c�l�bre introduction au terminal nomm�e Learn Enough [Command Line](https://www.learnenough.com/command-line-tutorial) to Be Dangerous. Cette ressource permet d'aller assez loin en d�tails dans le terminal.
